...
int main(){
    ...
    scene.objs = {
        ...
        Object(vec3(0.0f, -5.0f, -19.0f), 12.0f, Material(vec3(1.0f, 0.2f, 0.2f), 0.5f, 0.0f)),
        Object(vec3(15.0f, -2.0f, -11.0f), 1.5f, Material(vec3(0.1f, 1.0f, 0.5f), 0.5f, 0.0f)),
        Object(vec3(-12.0f, -1.0f, -6.0f), 1.0f, Material(vec3(0.4f, 0.3f, 1.0f), 0.5f, 0.0f)),
    };
    // -- loop -- //
    ...
    while(!glfwWindowShouldClose(engine.window)){
        ...
        for(auto& obj : scene.objs){
            ...
            for(auto& obj2 : scene.objs){
                if(&obj2 != &obj){
                    vec3 delta = obj2.position - obj.position;
